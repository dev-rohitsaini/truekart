        ...
        <div className="container">
          <div className="row">
            <div className="col-md-3 col-lg-4 col-xl-3">
              ...
              <p className="mb-0">
                The eCommerce industry is a constantly evolving space, and as
                such the terminology you need to know evolves too. This
                dictionary will help keep your expertise up-to date with all of
                these changes by providing definitions for over 200 important
                terms in this ever changing field.
              </p>
            </div>
